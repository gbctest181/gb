...
Droit d'auteur (c) 2012 Willow Systems Corp http://willow-systems.com
Droits d'auteur (c) 2010 Brinley Ang http://www.unbolt.net
...
http://phpjs.org/functions/base64_encode
    + original de: Tyler Akins (http://rumkin.com)
+ amélioré par: Bayron Guevara
+ amélioré par: Thunder.m
+ amélioré par: Kevin van Zonneveld (http://kevin.vanzonneveld.net)
+ bugfixé par: Pellentesque Malesuada
+ amélioré par: Kevin van Zonneveld (http://kevin.vanzonneveld.net)
+ amélioré par: Rafal Kukawski (http://kukawski.pl)
jSignature v2 jSignature Bouton Undo et plug-in de fonctionnalité d'annulation
jSignature v2 jSignature est un plugin d'exportation et d'importation au format "base30" personnalisé.
